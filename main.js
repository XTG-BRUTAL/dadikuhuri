...
const starts = async (DogeXeonOP = new WAConnection()) => {
	...
	console.log(color('\n> YT CHANNEL: DADI KUHURI ','silver'))
console.log(color('> GITHUB: XTG-BRUTAL ','silver'))
console.log(color('> WA NUMBER: +919101765679 ','silver'))
console.log(color('  BRUTAL Bot Inc. 2022','mediumseagreen'))
    ...
    console.log(color('<>','red'), color('But? Error? Suggestion? Visit Here:', 'aqua'), color('https://wa.me/919101765679'))
